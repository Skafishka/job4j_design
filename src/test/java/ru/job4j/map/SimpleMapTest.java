...
class SimpleMapTest {
    ...
    @Test
    void whenCheckPutTwoAndTwo() {
        SimpleMap<Integer, String> map = new SimpleMap<>();
        assertThat(map.put(0, "Two")).isTrue();
    }

    @Test
    void whenCheckPutThousandAndThousand() {
        SimpleMap<Integer, String> map = new SimpleMap<>();
        assertThat(map.put(1000, "Thousand")).isTrue();
        assertThat(map.put(null, "Thousand")).isFalse();
    }

    @Test
    void whenCheckGetTenAndTen() {
        SimpleMap<Integer, String> map = new SimpleMap<>();
        assertThat(map.put(10, "Ten")).isTrue();
        assertThat(map.get(10)).isEqualTo("Ten");
    }

    @Test
    void whenCheckGetEightAndEight() {
        SimpleMap<Integer, String> map = new SimpleMap<>();
        assertThat(map.put(8, "Eight")).isTrue();
        assertThat(map.put(10, "Ten")).isTrue();
        assertThat(map.get(8)).isEqualTo("Eight");
        assertThat(map.get(10).contains("Ten"));
    }
